...
// Badge de rede social exibido no canto inferior-direito do avatar
function ProviderBadge({ provider }: { provider: string | null | undefined }) {
  if (provider === 'google') {
    return (
      <span
        aria-label="Entrou com Google"
        className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-white ring-2 ring-white flex items-center justify-center shadow-sm"
      >
  ...
  if (provider === 'facebook') {
    return (
      <span
        ...
        className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-[#1877F2] ring-2 ring-white flex items-center justify-center shadow-sm"
      >
...
function Avatar({
    ...
    return (
      <div className="relative shrink-0">
        <img
          src={url}
          alt={name}
          className="w-12 h-12 rounded-full object-cover ring-2 ring-[#ffd700]/40"
        />
        {badge}
      </div>
    );
  ...
  return (
    <div className="relative shrink-0">
      <div className="w-12 h-12 rounded-full bg-[#003876] flex items-center justify-center ring-2 ring-[#ffd700]/40">
            ...
            {visibleItems.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                  <Avatar name={t.parent_name} url={t.avatar_url} provider={t.provider} />
