...
import RhSettingsPanel from './RhSettingsPanel';
...
export default function SettingsPage() {
  ...
  const CUSTOM_PANEL_TABS = ['whatsapp', 'visits', 'enrollment', 'contact', 'site', 'security', 'institutional', 'attendance', 'users', 'permissions', 'audit', 'financial', 'academico', 'ferramentas', 'rh', 'fiscal', 'ia'];
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            {/* Fields */}
            <div className={['whatsapp', 'visits', 'enrollment', 'contact', 'site', 'institutional', 'security', 'attendance', 'notifications', 'users', 'permissions', 'audit', 'financial', 'ferramentas', 'rh', 'fiscal', 'nfse-config', 'ia'].includes(activeTab) ? '' : 'p-6'}>
              {activeTab === 'whatsapp' ? (
          ...
          {!['whatsapp', 'visits', 'enrollment', 'contact', 'site', 'security', 'institutional', 'attendance', 'users', 'permissions', 'audit', 'financial', 'fiscal', 'ferramentas', 'rh', 'academico', 'ia'].includes(activeTab) && (
...
const NETWORK_CONFIGS: Record<NetworkKey, { label: string; color: string; placeholder: string; handleLabel: string; icon: (props: { size?: number; className?: string }) => React.ReactNode }> = {
  instagram: { label: 'Instagram', color: '#E1306C', placeholder: 'minha_escola',   handleLabel: 'Perfil (sem @)',
    icon: ({ size = 16, className }) => <Instagram size={size} className={className} /> },
  facebook:  { label: 'Facebook',  color: '#1877F2', placeholder: 'minha_escola',   handleLabel: 'Página ou perfil',
  ...
  whatsapp:  { label: 'WhatsApp',  color: '#25D366', placeholder: '5500000000000',    handleLabel: 'Número (com DDI, sem +)',
  ...
  twitter:   { label: 'Twitter/X', color: '#000000', placeholder: 'minha_escola',   handleLabel: 'Perfil (sem @)',
  ...
  linkedin:  { label: 'LinkedIn',  color: '#0A66C2', placeholder: 'minha-escola',  handleLabel: 'Empresa (slug)',
  ...
  youtube:   { label: 'YouTube',   color: '#FF0000', placeholder: 'minha_escola',   handleLabel: 'Canal (sem @)',
  ...
  tiktok:    { label: 'TikTok',    color: '#010101', placeholder: 'minha_escola',   handleLabel: 'Perfil (sem @)',
