    ...
    <div className={`flex flex-col rounded-2xl overflow-hidden border transition-all duration-200 ${
      ...
      <div className="bg-gray-50 dark:bg-gray-900/40 flex items-center gap-1 px-4 py-2.5 border-t border-gray-100 dark:border-gray-700/60">
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-brand-primary dark:hover:text-white px-3 py-1.5 rounded-lg hover:bg-white dark:hover:bg-gray-700/60 transition-colors"
        >
...
function MediaAttachment({ value, onChange, label = 'Imagem (opcional)', acceptVideo }: {
  ...
  const inputCls = 'w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 text-sm outline-none focus:border-brand-primary dark:focus:border-brand-secondary focus:ring-2 focus:ring-brand-primary/20 transition-all';
      ...
      {mode === 'url' ? (
        ...
        <div
          ...
          className={`border-2 border-dashed rounded-xl p-4 text-center transition-colors cursor-pointer ${
            dragOver
              ? 'border-brand-primary bg-blue-50/50 dark:bg-blue-900/10'
      ...
      <aside className="fixed right-0 top-0 h-full w-full max-w-2xl bg-white dark:bg-gray-900 z-50 shadow-2xl flex flex-col">
                              ...
                              <button
                                ...
                                className={`flex flex-col items-center gap-1.5 px-3 py-2.5 rounded-xl border text-xs font-medium transition-all ${
                                  active
                                    ...
                                    : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-600 hover:border-brand-primary/40'
                                }`}
                              >
                      ...
                      {(form.content.buttons || []).length === 0 && (
                        <div className="text-center py-4 border border-dashed border-gray-200 dark:border-gray-600 rounded-xl">
                          ...
                          <button
                            ...
                            className="text-xs text-brand-primary dark:text-brand-secondary hover:underline mt-2"
                          >
                          ...
                          <div key={sIdx} className="border border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden">
                            ...
                            <div className="p-3 space-y-2">
                              ...
                              <button
                                type="button"
                                onClick={addRow}
                                className="w-full text-xs text-gray-400 hover:text-brand-primary dark:hover:text-brand-secondary py-1.5 border border-dashed border-gray-200 dark:border-gray-600 rounded-lg hover:border-brand-primary/40 transition-colors flex items-center justify-center gap-1"
                              >
                                <Plus className="w-3 h-3" />
                                Adicionar item
                              </button>
        ...
        <div className="border-t border-gray-100 dark:border-gray-700 px-6 py-4 flex items-center gap-3 flex-shrink-0">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex-1 inline-flex items-center justify-center gap-2 bg-brand-primary text-white px-4 py-2.5 rounded-xl text-sm font-medium hover:bg-brand-primary-dark transition-colors disabled:opacity-60"
          >
...
function CategoriesDrawer({ onClose, onChanged }: { onClose: () => void; onChanged: () => void }) {
  ...
  const inputCls = 'w-full px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 text-sm outline-none focus:border-brand-primary dark:focus:border-brand-secondary focus:ring-2 focus:ring-brand-primary/20 transition-all';
                      ...
                      <div className="px-4 pb-4 space-y-4 border-t border-gray-100 dark:border-gray-700 pt-4 bg-gray-50/50 dark:bg-gray-800/50">
                        ...
                        <div className="flex gap-2 pt-1">
                          ...
                          <button
                            ...
                            disabled={saving !== null}
                            className="flex-1 py-2 bg-brand-primary hover:bg-brand-primary-dark text-white rounded-xl text-xs font-medium transition-colors disabled:opacity-40 flex items-center justify-center gap-1.5"
                          >
      ...
      {embedded && (
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleNew}
              className="inline-flex items-center gap-2 bg-brand-primary text-white px-4 py-2 rounded-xl font-medium text-sm hover:bg-brand-primary-dark transition-all"
            >
              <FilePlus2 className="w-4 h-4" />
              Novo Template
            </button>
